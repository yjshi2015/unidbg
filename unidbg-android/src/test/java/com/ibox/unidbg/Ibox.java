...
//        androidEmulator.getSyscallHandler().addIOResolver(this);
        ...
        dalvikVM = androidEmulator.createDalvikVM(new File("D:\\ibox相关\\0_apk包记录\\v1.1.5\\ibox1.1.5.apk"));
        dalvikVM.setVerbose(true);
        dalvikVM.setJni(this);
        new AndroidModule(androidEmulator, dalvikVM).register(memory);
        DalvikModule dalvikModule = dalvikVM.loadLibrary(new File("unidbg-android/src/test/resources/example_binaries/arm64-v8a/libtiger_tally.so"), false);
